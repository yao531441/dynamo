...
class HardwareSpec(BaseModel):
    ...
    acceleratorType: str = Field(default="auto", description="AcceleratorType specifies the type of accelerator hardware. When set to \"auto\" or omitted, the operator attempts auto-detection. Set explicitly (e.g., \"nvidia\", \"intel\") to skip auto-detection.")
    gpuSku: Optional[GPUSKUType] = Field(default=None, description="GPUSKU is the AIC hardware system identifier for the GPU. When omitted, the operator auto-detects this via InferHardwareSystem from cluster GPU node labels.")
