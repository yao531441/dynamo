...
如需快速概览，请参阅 [Planner overview](README.md)。如需了解架构内部机制，请参阅 [Planner 设计](../../design-docs/planner-design.zh-CN.md)。
...
- [Planner 设计](../../design-docs/planner-design.zh-CN.md) — 架构和算法内部机制
